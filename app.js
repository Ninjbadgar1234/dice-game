...
var hedHurtel = prompt("Хэдрүү уралдах вэ? Тоогоо оруулна уу.");
alert(
  "Тоглоомын дүрэм: Хэрвээ 1 буувал өрсөлдөгчрүү шилжинэ мөн HOLD товчыг дарснаар та оноогоо хадгалж өрсөлдөгч рүү тоглолт шилжинэ түрүүлж " +
    hedHurtel +
